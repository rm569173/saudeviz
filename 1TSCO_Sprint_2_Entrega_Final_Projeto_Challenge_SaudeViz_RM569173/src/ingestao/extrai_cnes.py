...
A API trava o "limit" em 20 registros e o CNES tem ~380 mil
estabelecimentos no pais. Em vez de varrer tudo, busca so os que aparecem
nas camadas ja materializadas: os com leito SUS ou com internacao no SIH.
Sao ~8 mil requisicoes, cobrindo 100% do que a solucao usa.

Por isso roda depois do SIH e dos leitos - e deles que sai a lista.
