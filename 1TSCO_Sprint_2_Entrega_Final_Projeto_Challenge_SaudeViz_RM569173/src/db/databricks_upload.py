...
Nenhuma credencial fica no arquivo. Defina antes de rodar, no terminal:

    $env:DATABRICKS_HOST  = "https://dbc-ec79b4c9-62ce.cloud.databricks.com"
    $env:DATABRICKS_TOKEN = "<seu Personal Access Token>"

O token sai em Settings > User > Developer > Access tokens.
