...
# Somas parciais por bloco. Media de medias daria o mesmo peso a blocos com
# poucas e muitas internacoes, entao as medias saem so no final.
SOMAS_FATO = [
...
def fato_internacao_mensal() -> pd.DataFrame:
    ...
    for uf, competencia, bloco in prata.itera_internacoes():
        # Filtra pelo ano de internacao, nao pela competencia: os arquivos de
        # 2025 entram so para recuperar dezembro/2024 faturado com atraso.
