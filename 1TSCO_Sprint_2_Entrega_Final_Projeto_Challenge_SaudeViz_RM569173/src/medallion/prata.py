...
# Faixas do campo COBRANCA, conforme o dicionario do SIH. O bloco de obito
# foi conferido contra MORTE = 1 em MG/dez-2024: 41 a 43 deram o mesmo total.
FAIXAS_DESFECHO = [
    (11, 19, "Alta"),
    (21, 29, "Permanencia"),
    (31, 32, "Transferencia"),
...
def _transforma_internacoes(bruto: pd.DataFrame) -> pd.DataFrame:
    ...
    # Competencia e o mes em que a AIH foi paga, nao o da internacao. Fica
    # por rastreabilidade, mas nunca como dimensao temporal.
