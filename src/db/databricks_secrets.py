...
Por que existe
--------------
Os notebooks precisam da senha do Oracle para gravar a camada Gold, mas senha
nao pode ser digitada em celula de notebook: fica no historico de revisoes, no
resultado exportado e em qualquer copia do arquivo. O Databricks resolve isso
com secret scopes - o notebook le o valor por referencia e o proprio produto
mascara a saida se alguem tentar imprimir.

Este script le as credenciais das SUAS variaveis de ambiente e as envia ao
Databricks. A senha nunca e escrita em disco pelo projeto nem aparece na tela.
