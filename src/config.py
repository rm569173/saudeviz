...
# Recorte do MVP: regiao Sudeste completa. As quatro UFs formam uma regiao de
# saude com fluxo real de pacientes entre si, o que torna a analise de
# transferencias interinstitucionais interessante - diferente de um conjunto
# de estados sem relacao assistencial. Cobre ~89 milhoes de habitantes.
UFS_MVP = ["ES", "MG", "RJ", "SP"]
...
# --------------------------------------------------------------------------
# ANO_CMPT/MES_CMPT do SIH e o mes em que a AIH foi PROCESSADA e paga, nao o
# mes em que o paciente internou. Medido nos proprios dados: a competencia
# 202401 de SP, MG, BA e RS traz 41,7% de internacoes de 2023, e a competencia
# 202406 tem apenas 58% de internacoes do proprio mes.
#
# Distribuicao da defasagem entre internar e ser faturado:
#   mes 0: 58%   mes 1: 27%   mes 2: 10%   mes 3: 4%   mes 4+: <1%
#
# Por isso a ingestao vai ate marco de 2025 (M+3), para capturar as
# internacoes de dezembro de 2024 que so foram pagas no ano seguinte. A
# analise depois filtra por ANO_ANALISE usando a data real de internacao.
...
# Colunas do SIH/SUS efetivamente usadas (das 113 disponiveis).
#
# A selecao foi validada empiricamente comparando o preenchimento em MG
# (123.002 AIHs em dez/2024) e AC (3.851 AIHs no mesmo mes): as colunas
# descartadas estao vazias ou constantes nos dois estados, e nao apenas na
# amostra pequena. Ver docs/dicionario_colunas.md.
COLUNAS_SIH = [
